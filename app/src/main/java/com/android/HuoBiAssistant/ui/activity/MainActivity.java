...
import com.android.HuoBiAssistant.util.SPUtils;
    ...
    public void setTabSelection(int index) {
        ...
        switch (index) {
            ...
            case 1:
                ...
                sale_image.setImageResource(R.mipmap.ic_sale_select);
                sale_text.setTextColor(MainActivity.this.getResources().getColor(R.color.primary_color));
